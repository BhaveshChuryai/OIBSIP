...
Bhavesh Churyai · Oasis Infobyte · AICTE OIB-SIP April 2026

About This Internship
I completed a 1-Month Virtual Internship in Web Development & Designing at Oasis Infobyte, under the AICTE Student Internship Program (OIB-SIP), April 2026.
Oasis Infobyte is an MSME-certified, ISO 9001:2015 company with AICTE recognition, known for delivering structured and industry-relevant internship programs. Over the course of this internship, I worked on 7 hands-on projects spanning three difficulty levels — progressing from building static HTML/CSS pages to fully functional web applications with persistent data storage and real-time interactivity.
Company: Oasis Infobyte
Duration: April 2026 – May 2026 (1 Month)
Program: AICTE OIB-SIP April P1 2026
Offer Letter Ref: OIB/L2/IP945

Task Overview
#TaskLevelTechnologiesStatus1Landing PageLevel 1HTML, CSSCompleted2Personal PortfolioLevel 1HTML, CSSCompleted3Temperature ConverterLevel 1HTML, CSS, JavaScriptCompleted4Calculator AppLevel 2HTML, CSS, JavaScriptCompleted5Tribute PageLevel 2HTML, CSSCompleted6Todo Web AppLevel 2HTML, CSS, JavaScriptCompleted7Login Authentication PageLevel 3HTML, CSS, JavaScriptCompleted
...
Writing clean, semantic HTML5 that is accessible and well-structured
Crafting fully responsive layouts using CSS Flexbox and Grid
Bringing pages to life with vanilla JavaScript — no frameworks, just fundamentals
Mastering DOM manipulation and real-time event handling
Persisting user data with the browser's localStorage API
Implementing client-side form validation and error feedback
Thinking like a designer — balancing aesthetics with usability
Managing projects with Git & GitHub for clean version control


Internship Details
Intern Name: Bhavesh Churyai
Domain: Web Development and Designing
Program: AICTE OIB-SIP April P1 2026
Reference No.: OIB/L2/IP945
Start Date: 05 April 2026
Duration: 1 Month
Mode: Virtual / Online
Company: Oasis Infobyte

Made with ❤️ during AICTE OIB-SIP April 2026 Internship at Oasis Infobyte
